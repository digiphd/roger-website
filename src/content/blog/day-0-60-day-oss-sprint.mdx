...
The harder question is whether I can use agents to build faster without building worse. Whether I can create useful software in public, at a consistent pace, while keeping the work reviewable, maintainable, and worth someone else’s time.
